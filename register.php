            ...
            <div class="row gy-3 gy-md-4 overflow-hidden">
              <div class="col-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="firstName" id="firstName" onkeyup="nameValidate(this.id);" required>
                </div>
              ...
              <div class="col-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="lastName" id="lastName" onkeyup="nameValidate(this.id);" required>
                </div>
